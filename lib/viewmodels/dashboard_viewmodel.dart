// lib/viewmodels/dashboard_viewmodel.dart (Alternative with DI)
...
class DashboardViewModel extends ChangeNotifier {
  ...
  DashboardViewModel(this._authService, this._packageService) {
    loadDashboardStats();
  }
...
class DashboardViewModel extends ChangeNotifier {
  ...
  final MockPackageService _packageService = MockPackageService(); // Changed to MockPackageService
