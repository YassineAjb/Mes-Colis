              ...
              child: Column(
                ...
                children: [
                          ...
                          if (widget.order.clientName != null) ...[
                            Row(
                              children: [
                                ...
                                Expanded(child: Text('Client: ${widget.order.clientName}')),
                              ],
                            ),
                  ...
                  if (orderViewModel.isLoadingStatuses)
                    ...
                    Container(
                      height: 250, // Fixed height for the status list
                      decoration: BoxDecoration(
                  ...
                  // Show selected status info - moved to bottom and made more compact
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'Nouveau statut: ${selectedStatus!.displayName}',
                                style: TextStyle(
          ...
          actions: [
            TextButton(
              ...
              child: const Text(
                'Annuler',
                style: TextStyle(
                  color: Colors.teal, // or Colors.teal[50] but needs to be non-const
                ),
              )
            ),
            ElevatedButton(
